  ...
  const features = [
    {
      ...
      description: "Automatically categorize and prioritize your tasks with AI-powered insights.",
      icon: (
    ...
    },
    {
      ...
      description: "Work seamlessly with your team and track progress in real-time.",
      icon: (
        <svg className="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      ...
      description: "Get insights into your productivity with detailed reports and metrics.",
      icon: (
        <svg className="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
